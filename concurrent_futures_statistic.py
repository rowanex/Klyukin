...
class InputConect:
    ...
    def start():
        ...
        with pool.ThreadPoolExecutor(max_workers=16) as executer:
            result = executer.map(InputConect().get_data_by_dicts, csv_files)
        salary_by_years_dict, number_of_vacancies_by_year_dict, salary_for_vacancy_by_years_dict, number_of_vacancies_by_year_for_vac_dict  = InputConect().print_prepare_data(result)
        statistic = Report(salary_by_years_dict, number_of_vacancies_by_year_dict, salary_for_vacancy_by_years_dict, number_of_vacancies_by_year_for_vac_dict, profession_name)
